...
-- CALL NumerosCarrosAlugadosporFuncionárioTipo();
DELIMITER $$
...
-- CALL MostrarCarrosAlugadosStand('Porto');
DELIMITER $$
...
-- CALL ListarFuncionarios_e_Funcao();
DELIMITER $$
...
-- CALL MostrarAlugueresPorFuncionario();
DELIMITER $$
